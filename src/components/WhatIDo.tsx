        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Specializing in building scalable architectures, real-time communication systems with WebRTC, and high-performance APIs using Nest.js and Next.js.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Turbo Repo</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Expertise in delivering custom WordPress solutions, plugin development, and high-performance CMS projects with a focus on SEO and performance.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
